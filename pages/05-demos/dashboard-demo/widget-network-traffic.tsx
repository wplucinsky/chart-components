...
const series: CartesianChartProps.SeriesOptions[] = [
  {
    name: "i-03736447",
    type: "line",
    data: networkTrafficData.map((datum) => ({ x: datum.date.getTime(), y: datum["i-03736447"] })),
  },
  {
    name: "i-06f70d90",
    type: "line",
    data: networkTrafficData.map((datum) => ({ x: datum.date.getTime(), y: datum["i-06f70d90"] })),
  },
  {
    name: "i-02924ba6",
    type: "line",
    data: networkTrafficData.map((datum) => ({ x: datum.date.getTime(), y: datum["i-02924ba6"] })),
  },
  {
    name: "i-0e36f15f",
    type: "line",
    data: networkTrafficData.map((datum) => ({ x: datum.date.getTime(), y: datum["i-0e36f15f"] })),
  },
];
