...
This package contains the source code of chart components in the [Cloudscape Design System](https://cloudscape.design/).
For more information about chart components, see [the documentation](https://cloudscape.design/components/charts/).
...
You can [create bug reports or feature requests](https://github.com/cloudscape-design/chart-components/issues/new/choose), or [start a discussion](https://github.com/cloudscape-design/components/discussions) to ask a question. To minimize duplicates, we recommend that you search for existing bug reports, feature requests, or discussions before initiating a new thread.
